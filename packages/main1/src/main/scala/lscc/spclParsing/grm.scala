...
object GrmPtr {
  ...
  given iemiOpsZeroLengthMatching
  : GrmPtrOpTraits1.forZeroLengthMatchingImpl[_Any, iemiOpsR.type ]
  = GrmPtrOpTraits1.forZeroLengthMatching[_Any]

  given iemiOpsEofs
  : GrmPtrOpTraits1.forEofMatchingImpl[_Any, lscalg.bnfParsing.BnfCompatibleFileReadPtr1.edgrl.type ]
  ...
  implicit
  final lazy val grmNumericLiteranAndWordsAndIdents
