...
transparent inline
given forNumericLiteranAndWordsAndIdents1
  [
    EOptConstructor
...
: forNumericLiteranAndWordsAndIdents1[EOptConstructor, PAny]
=
  new AnyRef with forNumericLiteranAndWordsAndIdents1[EOptConstructor, PAny]
  {
    val SpclAfterDigestTupleOption: VO_EOptConstructor.value.type = valueOf 
    val iemiOpsR : rr.type = valueOf
  }

trait forNumericLiteranAndWordsAndIdents1
  [
    EOptConstructor
    <: Singleton & GrmSpclFileReadPtr1.GeneralisedSpclAfterDigestTupleOption[PAny]
    ,
...
extends
AnyRef
with ForNumericLiteranAndWordsAndIdentsImpl._Main[PAny]
with ForNumericLiteranAndWordsAndIdentsImpl._Main1Deps[EOptConstructor, PAny]
