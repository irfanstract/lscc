 ...
 * 
 */
object BindingFirstTermOrTypeAscribedExprPrf
{
  ;
    ...
    ({
      ...
      ({
        ...
        ({
          ...
          = {
            ;
            import lscc.spclGrammar.forTermAscriptiveScrut.FbfSpecificToTermOrTypeAscriptiveInfixAndRhsPrf as ForTermOrTypeAscriptiveInfixAndRhs
 ...
 * 
 */
object FbfSpecificToTermOrTypeAscriptiveInfixAndRhsPrf
{ 
  ;
