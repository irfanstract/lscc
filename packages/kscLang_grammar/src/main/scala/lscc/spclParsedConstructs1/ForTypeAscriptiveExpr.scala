 ...
 * 
 */
export lscc.spclGrammar.forTermAscriptiveScrut.BindingFirstTermOrTypeAscribedExprPrf as ForBindingFirstTermOrTypeAscribedExprP

export ForBindingFirstTermOrTypeAscribedExprP.apply as forBindingFirstTermOrTypeAscribedExprP
 ...
 * 
 */
export lscc.spclGrammar.forTermAscriptiveScrut.FbfSpecificToTermOrTypeAscriptiveInfixAndRhsPrf as ForTermOrTypeAscriptiveInfixAndRhs
